...
export default function Sidebar() {
  ...
  return (
    <aside className="sidebar">
      ...
      <p className="font-sans text-[14px] leading-relaxed text-navy" style={{ marginBottom: 4 }}>
        Ready to grow something new?<br />Let's chat.
      </p>
      ...
      <div className="flex items-center gap-2">
        ...
        <a
          href="https://drive.google.com/file/d/1oSHIgcuBWo6L9dmaBmn4xB9ssO6JzjGA/view?usp=sharing"
          target="_blank"
          rel="noopener noreferrer"
