      ...
      <div className="cs-outer-wrap" style={{ paddingLeft: 32, paddingRight: 32, paddingTop: 32, display: 'flex', flexDirection: 'column', gap: 0 }}>
        ...
        <Section id="ea-intro">
          ...
          <div style={{ marginTop: 108 }}>
            ...
            <p className="font-landing-body" style={{ fontSize: 17, color: 'var(--color-secondary)', marginBottom: 12 }}>
              To understand the scope of the problem, I reviewed 62 support tickets filed in the past six months with the Customer Support Specialist and ran a thematic analysis. Three friction points surfaced consistently.
            </p>
